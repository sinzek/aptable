(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_671e27._.js", {
...
;
;
const buttonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-aleo relative overflow-hidden transition-all duration-100 active:brightness-[0.8] hover:translate-y-[-2px] active:drop-shadow-none active:translate-y-0 hover:button-shadow active:shadow-none", {
    variants: {
        variant: {
...
const GetStartedButton = ()=>{
    ...
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GetStartedButton.useCallback[handleClick]": ()=>{
            document.dispatchEvent(triggerAnimationEvent);
            setTimeout({
                "GetStartedButton.useCallback[handleClick]": ()=>{
                    router.push("/start");
                }
            }["GetStartedButton.useCallback[handleClick]"], 500);
        }
    }["GetStartedButton.useCallback[handleClick]"], [
        router
    ]);
...
_s(GetStartedButton, "ZuYBnNo7SnkY6uMZKFM6kA/rC9s=", false, function() {
    return [
...
;
;
const SearchBar = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(_c = ({ placeholder, className, ...props }, ref)=>{
...
;
var _c, _c1;
__turbopack_refresh__.register(_c, "SearchBar$React.forwardRef");
__turbopack_refresh__.register(_c1, "SearchBar");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/components/context/backgroundManager.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(with-navbar)/layout.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_671e27._.js.map