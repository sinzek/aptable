                    ...
                    <div className="flex flex-col gap-6 text-center md:text-left items-center md:items-start">
                        ...
                        <div className="flex flex-col gap-6 max-w-lg">
                            <h2 className="text-xl lg:text-2xl text-balance font-aleo font-extrabold text-white">
                                A game-ified online course platform that&apos;s
                                effective and fun.
                            </h2>
                            <h3 className="text-base md:text-lg lg:text-xl font-aleo font-semibold text-purple-100">
                                Interactive lessons, a tycoon-style progression
                                system, and collectible rewards— Aptable turns
                                studying into an addictive experience.
                            </h3>
                        </div>
