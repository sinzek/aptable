        ...
        <AnimatePresence mode="wait">
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        className="bg-darkpurple-600/20 toggle-shadow py-6 md:py-12 px-8 w-auto rounded-[20px] flex flex-col items-center gap-6 justify-center backdrop-blur-[10px]"
